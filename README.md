...
1. Get a free API key at the [TileSmith dashboard](https://tilesmith.kleeblatt.space) and add it as the `TILESMITH_API_KEY` secret in your repo (**Settings → Secrets and variables → Actions**).
...
Open TileSmith settings · Marketplace
