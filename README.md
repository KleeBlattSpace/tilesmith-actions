...
1. Sign in at the [TileSmith dashboard](https://tilesmith.kleeblatt.space) (keys, rotation, statistics), create an API key, and add it as the `TILESMITH_API_KEY` secret in your repo (**Settings → Secrets and variables → Actions**).
...
Sign in to TileSmith — API keys, rotation, run statistics · Marketplace
